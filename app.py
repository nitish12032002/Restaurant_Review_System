...
model = pickle.load(open('ITS1.pkl','rb'))
model = pickle.load(open('ITS2.pkl','rb'))
model = pickle.load(open('ITS3.pkl','rb'))
model = pickle.load(open('ITS4.pkl','rb'))
model = pickle.load(open('ITS5.pkl','rb'))   
...
if st.button("Decision Tree Classification"):
  result=review(text)
  st.success('Model has predicted {}'.format(result))
if st.button("K-nearest Neighbor Classification"):
  result=review(text)
  st.success('Model has predicted {}'.format(result))
